...
# Local copy of:
# https://github.com/gpu-mode/reference-kernels/blob/main/problems/linalg/qr_v2/reference.py
#
# The official file imports input_t/output_t from Popcorn's injected task.py.
# Keep this copy self-contained so local tests can use the same generator and checker.
...
def _check_tensor(
    name: str, value: torch.Tensor, shape: tuple[int, ...], device: torch.device
) -> str | None:
